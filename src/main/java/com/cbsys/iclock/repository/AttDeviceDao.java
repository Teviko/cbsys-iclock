...
public interface AttDeviceDao extends JpaRepository<AttDevice, Long> {
	...
	@Query(value = "select ad.id, ad.serial_number, ad.device_model,IFNULL( UNIX_TIMESTAMP(ad.last_online_time)*1000,0) as dbLastOnlineTime, ad.offsite_att, ad.device_type,ad.corp_token,ad.time_zone_offset,ad.time_zone_id,ad.default_work_code from t_att_devices as ad ", nativeQuery = true)
